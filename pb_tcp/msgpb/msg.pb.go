...
type UnAggregatedMetric struct {
	Id     []byte    `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Values []float64 `protobuf:"fixed64,2,rep,packed,name=values" json:"values,omitempty"`
}

func (m *UnAggregatedMetric) Reset()                    { *m = UnAggregatedMetric{} }
func (m *UnAggregatedMetric) String() string            { return proto.CompactTextString(m) }
func (*UnAggregatedMetric) ProtoMessage()               {}
func (*UnAggregatedMetric) Descriptor() ([]byte, []int) { return fileDescriptorMsg, []int{8} }

func (m *UnAggregatedMetric) GetId() []byte {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *UnAggregatedMetric) GetValues() []float64 {
	if m != nil {
		return m.Values
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*UnAggregatedMetric)(nil), "msgpb.UnAggregatedMetric")
}
...
func (m *UnAggregatedMetric) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *UnAggregatedMetric) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Values) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintMsg(dAtA, i, uint64(len(m.Values)*8))
...
func (m *UnAggregatedMetric) Size() (n int) {
	var l int
	_ = l
	l = len(m.Id)
	if l > 0 {
	...
	if len(m.Values) > 0 {
		n += 1 + sovMsg(uint64(len(m.Values)*8)) + len(m.Values)*8
	}
	return n
}
...
func (m *UnAggregatedMetric) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UnAggregatedMetric: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UnAggregatedMetric: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorMsg = []byte{
	...
	,
}
